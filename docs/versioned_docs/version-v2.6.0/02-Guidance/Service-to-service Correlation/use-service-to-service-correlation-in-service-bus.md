...
![Product API ↔️ Stock API application map example](/media/servicebus-worker-service-correlation-example-applicationmap.png)
...
![Product API ↔️ Stock API transaction search example](/media/servicebus-worker-service-correlation-example-transactionsearch.png)
