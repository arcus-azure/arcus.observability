...
{
    public class ApplicationInsightsSinkCustomDependencyTests : ApplicationInsightsSinkTests
    {
        public ApplicationInsightsSinkCustomDependencyTests(ITestOutputHelper outputWriter) : base(outputWriter)
        {
        }
