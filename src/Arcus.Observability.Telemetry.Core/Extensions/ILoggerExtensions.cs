...
namespace Microsoft.Extensions.Logging
{
    public static class ILoggerExtensions
    {
        ...
        /// </summary>
        /// <param name="logger">Logger to use</param>
        /// <param name="accountName">Account of the resource</param>
        ...
        /// <param name="context">Context that provides more insights on the dependency that was measured</param>
        public static void LogEventHubsDependency(this ILogger logger, string accountName, string eventHubName, bool isSuccessful, DependencyMeasurement measurement, Dictionary<string, object> context = null)
        {
            Guard.NotNull(logger, nameof(logger));
            Guard.NotNullOrWhitespace(accountName, nameof(accountName));
            Guard.NotNullOrWhitespace(eventHubName, nameof(eventHubName));

            LogEventHubsDependency(logger, accountName, eventHubName, isSuccessful, measurement.StartTime, measurement.Elapsed, context);
        }
        ...
        /// <param name="duration">Duration of the operation</param>
        /// <param name="context">Context that provides more insights on the dependency that was measured</param>
        public static void LogEventHubsDependency(this ILogger logger, string accountName, string eventHubName, bool isSuccessful, DateTimeOffset startTime, TimeSpan duration, Dictionary<string, object> context = null)
        {
            Guard.NotNull(logger, nameof(logger));
            Guard.NotNullOrWhitespace(accountName, nameof(accountName));
            Guard.NotNullOrWhitespace(eventHubName, nameof(eventHubName));
            ...
            logger.LogInformation(DependencyFormat, "Azure Event Hubs", accountName, eventHubName, duration, startTime.ToString(CultureInfo.InvariantCulture), isSuccessful, context);
        }
